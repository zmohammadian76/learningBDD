...
Scenario: a cashbox is removed only when the receipt voucher has not been dedied
        ...
        When 'Mina' tries to remove the cashbox with id '100'
        Then she gets error 'a receipt voucher has been defined for this cashbox' and code 'C-BR-2007'  
...
Scenario: a cashbox is removed only when the peyment voucher has not been
        ...
        When 'Mina' tries to remove the cashbox with id '100'
        Then she gets error 'a peyment voucher has been defined for this cashbox' and code 'C-BR-2008' 
